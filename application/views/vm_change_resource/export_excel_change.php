...
/**
 * ============================================================================
 * File Name    : export_excel_change.php
 * Modul        : VM Change Resource
 * Purpose      : Template Engine untuk output laporan Excel (.xls) Native
 * Architecture : Enterprise Memory-Safe I/O Streaming
 * ============================================================================
 */

$filename = $filename ?? "Laporan_Capacity_Management_" . date("Ymd_His");
...
// [QA FIX]: Menyuntikkan UTF-8 Byte Order Mark (BOM) agar Excel versi lawas tidak merender karakter "gibberish"
echo "\xEF\xBB\xBF";
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        /* Proteksi Auto-Format Formula Excel */
        ...
        .gs-table th { background-color: #4A6E8E; font-weight: bold; color: #ffffff; text-align: center; vertical-align: middle; height: 30px; }
...
<body>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 10px;">
        <tr>
            <td colspan="<?= count(
                ...
                LOG PERUBAHAN RESOURCE VIRTUAL MACHINE
            </td>
        </tr>
        <tr>
            <td colspan="<?= count(
    ...
    <table class="summary-table">
        <tr>
            ...
            <td colspan="4" class="bg-title" style="font-size: 11pt; padding: 8px;">EXECUTIVE SUMMARY & KAPASITAS (PERIODE INI)</td>
        </tr>
        <tr>
            <td style="border: none;"></td>
        ...
        <tr>
            ...
            <td align="center" class="text-success"><?= $summary["ticket"]["done"] ?> Tiket</td>
            <td align="center" class="text-danger"><?= $summary["ticket"]["pending"] ?> Tiket</td>
            <td align="center" class="font-bold"><?= $summary["ticket"]["total"] ?> Tiket</td>
        </tr>
        ...
        <tr>
            ...
            <td align="center" class="text-success"><?= $summary["vm"]["sudah"] ?> VM</td>
            <td align="center" style="color: #b45309; font-weight: bold;"><?= $summary["vm"][
                "cancel"
            ] ?> VM</td>
            <td align="center" class="text-danger"><?= $summary["vm"]["menunggu"] ?> VM</td>
            <td align="center" class="font-bold"><?= $summary["vm"]["total"] ?> VM</td>
        </tr>
        ...
        <tr>
            <td style="border: none;"></td>
            <th align="left">AKUMULASI PENAMBAHAN KAPASITAS</th>
            <th align="center" class="text-success">TOTAL PLUS (+)</th>
            <th align="center" class="text-danger">TOTAL MINUS (-)</th>
            <th align="center" colspan="2">NET DELTA KAPASITAS</th>
        </tr>
        <tr>
            <td style="border: none;"></td>
            <td><b>vCPU (Core)</b></td>
            <td align="center" class="text-success">+ <?= $summary["res"]["cpu_plus"] ?> Core</td>
            <td align="center" class="text-danger">- <?= $summary["res"]["cpu_minus"] ?> Core</td>
            <td align="center" class="font-bold" colspan="2"><?= $summary["res"][
                "cpu_net"
            ] ?> Core</td>
        </tr>
        <tr>
            ...
            <td align="center" class="text-success">+ <?= $summary["res"]["ram_plus"] ?> GB</td>
            <td align="center" class="text-danger">- <?= $summary["res"]["ram_minus"] ?> GB</td>
            <td align="center" class="font-bold" colspan="2"><?= $summary["res"][
                "ram_net"
            ] ?> GB</td>
        </tr>
        <tr>
            <td style="border: none;"></td>
            <td><b>Storage (Disk)</b></td>
            <td align="center" class="text-success">+ <?= number_format(
                $summary["res"]["hdd_plus"],
                0,
                "",
                "",
            ) ?> GB</td>
            <td align="center" class="text-danger">- <?= number_format(
                $summary["res"]["hdd_minus"],
                0,
                "",
                "",
            ) ?> GB</td>
            <td align="center" class="font-bold" colspan="2"><?= number_format(
                $summary["res"]["hdd_net"],
                0,
                "",
                "",
        ...
        <tr>
            <td style="border: none;"></td>
            <td colspan="4" style="font-size: 9pt; color: #64748b; font-style: italic; border: none; padding-top: 5px;">
                *nb: Akumulasi kapasitas di atas dihitung hanya berdasarkan tiket yang status akhirnya telah selesai dieksekusi di lapangan.
            </td>
        </tr>
    </table>
